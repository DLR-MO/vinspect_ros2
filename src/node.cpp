...
VinspectNode::VinspectNode(const rclcpp::NodeOptions & options) : Node("vinspect_node", options)
{
  ...
  rclcpp::TimerBase::SharedPtr timer_data = rclcpp::create_timer(
    this, this->get_clock(), timer_duration, [this]() -> void {this->showCurrentData();},
  ...
  rclcpp::TimerBase::SharedPtr timer_status = rclcpp::create_timer(
    ...
    [this]() -> void {this->showStatus();}, timer_status_callback_group);
  ...
  rclcpp::TimerBase::SharedPtr timer_tsdf = rclcpp::create_timer(
    ...
    [this]() -> void {this->showTSDF();}, timer_tsdf_callback_group);
   ...
   */
void VinspectNode::showCurrentData()
{
...
void VinspectNode::finish()
{
   ...
   * @return
   */
void VinspectNode::jointCb(sensor_msgs::msg::JointState msg)
{
   ...
   * @return
   */
void VinspectNode::sparseCb(vinspect_msgs::msg::Sparse msg)
{
  if (!paused_) {
...
void VinspectNode::sparseInteractiveMarkerCb(
  visualization_msgs::msg::InteractiveMarkerFeedback feedback)
{
   ...
   */
sensor_msgs::msg::Image VinspectNode::vectorToImageMsg(
  ...
  3>>> & image)
{
   ...
   * @return None
   */
void VinspectNode::denseInteractiveMarkerCb(
  visualization_msgs::msg::InteractiveMarkerFeedback feedback)
{
  if (feedback.event_type == visualization_msgs::msg::InteractiveMarkerFeedback::MOUSE_UP) {
   ...
   * @return None
   */
void VinspectNode::pubRefMeshDense(std::array<double, 7> pose)
{
...
void VinspectNode::denseDataReq(std_msgs::msg::String)
{
  mtx_.lock();
...
double VinspectNode::roundValue(double value)
{
...
void VinspectNode::multiDenseDataReq(std_msgs::msg::Int32 msg)
{
   ...
   * @return None
   */
void VinspectNode::pubRefMesh(float transparency)
{
  visualization_msgs::msg::Marker marker = visualization_msgs::msg::Marker();
   ...
   * @return None
   */
void VinspectNode::settingsCb(vinspect_msgs::msg::Settings msg)
{
...
void VinspectNode::cameraInfoCb(sensor_msgs::msg::CameraInfo msg)
{
...
std::string VinspectNode::removeWordFromString(const std::string str, const std::string word)
{
   ...
   */
Eigen::Matrix4d VinspectNode::transformStampedToTransformMatix(
...
void VinspectNode::startReconstruction(
...
void VinspectNode::stopReconstruction(
...
RCLCPP_COMPONENTS_REGISTER_NODE(VinspectNode)
